...
#if defined(_WIN32) // use preprocessors for particular platform
#ifndef _WIN32_WINNT
#define _WIN32_WINNT 0x0600
#endif
#include <winsock2.h>
#include <ws2tcpip.h>
#pragma comment(lib, "ws2_32.lib") // link for work with winsock
...
// make interoperability of Berkeley and WinSock interfaces
#if defined(_WIN32)
